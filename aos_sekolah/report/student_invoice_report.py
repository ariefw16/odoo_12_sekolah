...
class AccountInvoiceStudentReport(models.Model):
    _name = "account.invoice.student.report"
    ...
    _depends = {
        'account.invoice': [
            ...
            'residual', 'state', 'type', 'user_id', 'year_id', 'level_id', 'grade_id', 'grade_line_id'
        ],
